...
- 구글 AI 오버뷰는 검색 1~12위를 요약하고, ChatGPT와 Perplexity는 신뢰도 높은 도메인을 우선하므로 SEO 순위가 GEO 성과에
  직접 영향을 미친다.
...
day: Day 09
duration: '13:04'
enriched_at: '2026-05-08T09:14:51+09:00'
id: C-009
kind: study
speaker: 노아브랜딩
status: published
summary:
  en: Learn GEO (Generative Engine Optimization) strategies to get your content cited
    in AI-generated search responses from ChatGPT and Perplexity in the evolving search
    landscape.
  ko: ChatGPT, Perplexity 등 생성형 AI의 확산으로 변화하는 검색 환경에서 내 콘텐츠가 AI 답변에 인용되도록 하는 GEO(Generative
    Engine Optimization) 전략을 단계별로 학습한다.
tags:
- '#geo'
- '#seo'
- '#생성형ai'
