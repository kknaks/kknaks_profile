...
type: reference
id: 2025-01-17-Day14
title: Day14 K8S 배포 세팅(Redis 세션·kubeconfig 배포)
summary: 쿠버네티스에 스프링 부트를 올리며 파드가 라운드로빈으로 갈리는 탓에 세션을 Redis로 빼고, 레지스트리 시크릿·Nginx Proxy Manager 스트림 포워딩을 설정한 뒤 배포 방식을 AWS SSM에서 kubeconfig 기반 kubectl로 바꾼 회차
author: 이건학
date: 2025.01.17
tags:
  - 멋쟁이사자처럼
  - kubernetes
  - CI/CD
stack: [Kubernetes, Spring Boot, Redis, GitHub Actions]
links: [2025-01-16-Day13, 2025-01-20-Day15]
---
...
- 해당 방식으로 수동 업데이트를 진행 할 수 있다.
  ...
  ![image](https://github.com/user-attachments/assets/e2af836f-b314-410d-85a5-0afd7370209d)
...
- 깃허브에 푸쉬하면 자동으로 배포가 진행된다.
  ![image](https://github.com/user-attachments/assets/63181103-eea0-4bfc-b589-a431940625c8)