...
type: reference
id: 2025-01-15-Day12
title: Day12 Kubernetes 기초
summary: 쿠버네티스의 클러스터 구조(마스터·워커 노드와 각 구성요소)와 파드·서비스 개념, kubeadm으로 클러스터를 세우는 과정, 그리고 Deployment→ReplicaSet→Pod 계층과 롤링 업데이트를 정리한 회차
author: 이건학
date: 2025.01.15
tags:
  - 멋쟁이사자처럼
...
- vpc1-k8s.sik2.site 도메인 이름에 대한 IP 주소가 있어야 api 서버에 접속할 수 있다.
  ...
  ![image](https://github.com/user-attachments/assets/99f1ea31-8306-4fb9-92eb-31345806abbf)
...
2) aws 클러스터 생성
   1. on master
      ...
      - -v=5: 로그 레벨을 지정한다.
         ...
         ![image](https://github.com/user-attachments/assets/7456f265-0298-457f-bac3-2c92a8a8d625)
   ...
   - 마스터노드에서 생성된 kubeadm join 명령어를 통해 워커 노드를 마스터 노드에 연결한다.
     ...
     - --discovery-token-ca-cert-hash: 인증서 해시를 지정한다.
       ![image](https://github.com/user-attachments/assets/1f59182f-a310-4f00-98ea-bb4ecacc0f40)
...
- ``kubectl get nodes``로 결과를 확인 할 수 있다.
  ...
  ![image](https://github.com/user-attachments/assets/6055483d-1b55-4958-9afc-13cc969dc37b)
...
- 마스터노드에서는 pod에 대해 조회를 할 수 있다.
  ...
  ```
    ...
    ![image](https://github.com/user-attachments/assets/d5cf7b45-7697-4d05-8b7c-6d69f98c46f2)
...
- 접속확인 (tab으로 자동완성)
  ...
  ![image](https://github.com/user-attachments/assets/9e4498b0-acef-48ea-9f64-c4d0abc4f3fc)
