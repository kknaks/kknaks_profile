...
- java
stack: [Java]
links: [2024-07-16-Day36, 2024-07-18-Day38]
---
...
- 정적 메소드는 클래스 이름 뒤에 ::기호를 붙인다.

```java
클래스::메서드
```

- 인스턴스 메서드는 객체를 생성하여 레퍼런스를 만들고 ::기호를 붙인다.
...
- 기존 람다식 구현하는 방법
  ...
  3. 람다식으로 만든다.
  4. 메서드레퍼런스로 변경한다.
- 다음과 같이 인터페이스와 static 클래스를 구성한다.
