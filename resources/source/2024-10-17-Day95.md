...
summary: 뷰 이름을 생략했을 때 요청 URL이 뷰 이름이 되는 기본 규칙과 InternalResourceViewResolver, 프론트 컨트롤러와 페이지 컨트롤러 사이에 끼는 인터셉터, 그리고 @ExceptionHandler·@ControllerAdvice·web.xml로 이어지는 예외 처리 우선순위를 정리한 회차
author: 이건학
date: 2024.10.17
tags:
  - bitcamp
