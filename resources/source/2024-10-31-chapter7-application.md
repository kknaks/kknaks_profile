---
type: reference
id: 2024-10-31-chapter7-application
title: 7장 응용계층, 사람이 쓰는 프로토콜의 단계
summary: 클라이언트-서버와 주요 프로토콜·포트, HTTP 메시지의 시작라인·헤더·바디와 상태 코드, DNS의 계층적 질의(캐시→루트→TLD→권한 네임서버), DHCP의 IP 자동 할당, SMTP·POP3의 메일 3단계, 그리고 7계층 로드밸런서를 정리한 장
author: 이건학
date: 2024.10.31
tags:
  - network
