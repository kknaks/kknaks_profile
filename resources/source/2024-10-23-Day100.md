---
type: reference
id: 2024-10-23-Day100
title: Day100 실습프로젝트(Thymeleaf)
summary: 스프링 부트에 Thymeleaf를 붙이는 prefix·suffix 설정과, 공통 head를 조각(fragment)으로 떼어 replace로 끼우는 방법, 체크박스의 선택 상태를 data-th-checked로 표현하는 예를 정리한 회차
author: 이건학
date: 2024.10.23
tags:
  - bitcamp
