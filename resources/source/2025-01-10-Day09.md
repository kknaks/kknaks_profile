...
id: 2025-01-10-Day09
title: Day09 JWT
summary: 헤더·페이로드·서명 세 조각으로 된 JWT를 jjwt로 발급·검증하고, 쿠키에 담아 보내 Spring Security 필터체인에서 SecurityContext에 인증 객체를 심는 인가 흐름까지 만든 회차
author: 이건학
date: 2025.01.10
tags:
  - 멋쟁이사자처럼
...
![image](https://github.com/user-attachments/assets/ce1b9116-eace-4dcc-be8f-a84d4e6fd16a)
