...
summary: 멀티프로세스와 멀티쓰레드를 가른 뒤 Runnable 구현·Thread 상속·익명 클래스로 작업 쓰레드를 만들어 start()로 실행하고, 쓰레드 이름과 다섯 상태·sleep()·join()까지 배운다. 양보·동기화·안전종료·데몬쓰레드는 소제목만 남았다
author: 이건학
date: 2024.08.05
tags:
- bitcamp
- java
stack: [Java]
links: [2024-07-30-Day46, 2024-08-06-Day51]
---
