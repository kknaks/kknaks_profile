...
summary: 프로퍼티 값 자동 형변환과 CustomEditor, @Autowired·@Qualifier·@Resource로 주입을 애노테이션으로 옮기는 과정, 그것을 실제로 수행하는 BeanPostProcessor, 그리고 context 태그와 @Configuration·@PropertySource·@ComponentScan을 정리한 회차
author: 이건학
date: 2024.10.04
tags:
  - bitcamp
