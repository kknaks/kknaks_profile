...
summary: 변경·삭제 화면을 서블릿으로 만들고, HeaderServlet 을 include 로 끼워 중복을 없애며, 정적 form.html·index.html 을 서블릿으로 옮기고, 로그아웃에서 세션 무효화와 리다이렉트를 다뤘다. 끝에 HTTP 메서드 여덟 개의 멱등성·안전성 표가 붙어 있다
author: 이건학
date: 2024.08.29
tags:
- bitcamp
