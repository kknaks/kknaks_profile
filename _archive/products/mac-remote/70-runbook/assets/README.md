...
> App Store 제출용 바이너리 자산을 모으고 상태를 추적한다. 절차는 [RB-002](../runbook-002-ios-testflight-appstore.md).
...
1. 창 목록 탭 — 창 카드 + 아이콘 ([[spec-001-window-list|MRT-SPEC-001]])
2. 매크로 탭 — 매크로 버튼 그리드 ([[spec-003-key-input|MRT-SPEC-003]])
3. 설정 탭 — QR 페어링 화면 ([[spec-007-pairing|MRT-SPEC-007]])
