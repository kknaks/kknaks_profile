...
- Mac에 무료 헬퍼 앱 **MacHelper** 설치·실행 (메뉴바 앱)
- iPhone과 Mac이 동일한 Wi-Fi에 연결
...
**창 전환·키 입력이 안 돼요**
- Mac 시스템 설정 → 개인정보 보호 및 보안 → 손쉬운 사용에서 MacHelper를 허용하세요.

## 문의
- 이메일: kknaks@medisolveai.com
...
- The free **MacHelper** companion app installed and running on the Mac (menu bar app)
- iPhone and Mac connected to the same Wi‑Fi
...
**Window switching / key input doesn't work**
- Allow MacHelper under System Settings → Privacy & Security → Accessibility on the Mac.
