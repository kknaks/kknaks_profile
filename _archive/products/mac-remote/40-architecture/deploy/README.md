...
1. Mac: [MRT-RB-001 DMG 배포](../../70-runbook/runbook-001-mac-dmg-release.md).
2. iOS: [MRT-RB-002 TestFlight / App Store 심사](../../70-runbook/runbook-002-ios-testflight-appstore.md).
