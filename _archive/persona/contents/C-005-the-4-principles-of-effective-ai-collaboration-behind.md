...
- 'Goal-Driven Execution: ''버그 수정해''가 아닌 ''버그를 재현하는 테스트를 작성하고 통과시켜''로 표현하면, 검증 없는
  작업을 방지한다.'
date: 2026-05-03
day: Day 05
duration: '12:44'
enriched_at: '2026-05-03T12:57:39+09:00'
id: C-005
kind: study
speaker: castlestudio
status: published
summary:
  en: 'How a simple 65-line CLAUDE.md guide transformed AI code generation: four principles
    to make AI assistants work precisely as intended'
...
- '#productivity'
title:
  en: 'The 4 Principles of Effective AI Collaboration: Behind GitHub''s 100k-Star
    CLAUDE.md'
