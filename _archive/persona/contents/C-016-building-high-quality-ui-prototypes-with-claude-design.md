...
- 피그마 커뮤니티의 검증된 UI 키트(Apple iOS, Google Material Design, Wanted 등)를 .fig 파일로 다운로드하여
  클로드 디자인에 업로드할 수 있다.
...
day: Day 16
duration: '27:59'
enriched_at: '2026-05-22T12:59:09+09:00'
id: C-016
kind: tutorial
speaker: 빌더 조쉬 Builder Josh
status: published
summary:
  en: Maximize Claude Design performance with design systems, then build interactive
    prototypes using PRD-based workflow and Claude Code integration
