...
- 관련 work: [[v1_0_1-work-003-key-input|MRT-WORK-003]] (키 입력 구현), [[v1_0_1-work-017-hold-modifiers|MRT-WORK-017]] (Hold 모드), [[v1_0_1-work-005-websocket-server|MRT-WORK-005]] (계약 key/holdModifiers/releaseModifiers 메시지)
- 범위
...
| Work | 범위 |
|---|---|
| [[v1_0_1-work-003-key-input\|MRT-WORK-003]] | 키 입력 구현 — CGEvent, VirtualKeyMap, modifier 조합 |
| [[v1_0_1-work-017-hold-modifiers\|MRT-WORK-017]] | Hold 모드 — holdModifiers/releaseModifiers, heldModifiers 상태, hold UI |
| [[v1_0_1-work-005-websocket-server\|MRT-WORK-005]] | 계약 key/holdModifiers/releaseModifiers 메시지 (WS 서버) |
