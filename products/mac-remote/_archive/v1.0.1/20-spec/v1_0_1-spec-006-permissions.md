...
- 관련 work: [[v1_0_1-work-001-cli-prototype|MRT-WORK-001]] (권한 확인 프로토타입), [[v1_0_1-work-006-menubar-app|MRT-WORK-006]] (메뉴바 권한 상태/안내 UI)
- 범위(In/Out)
...
| Work | 범위 |
|---|---|
| [[v1_0_1-work-001-cli-prototype\|MRT-WORK-001]] | 권한 확인 로직 (AXIsProcessTrusted + 창 제목 수집 테스트) (CLI) |
| [[v1_0_1-work-006-menubar-app\|MRT-WORK-006]] | 메뉴바 권한 상태/안내 UI + 시스템 설정 열기 |
