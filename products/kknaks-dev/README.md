...
| inbox 승인 파이프라인 + concept 층 (BL-003) | BL-003·DEC-010~013 accepted · spec 9건 · 40-arch · **WORK-012·013 done** · **WORK-014 done** (Slack→큐 · route 게이트 · admin 화면) | WORK-015 (나머지 게이트 + 발행) |
