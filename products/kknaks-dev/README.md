...
| inbox 승인 파이프라인 + concept 층 (BL-003) | BL-003·DEC-010~013 accepted · spec 9건 · 40-arch · **WORK-012·013 done** · WORK-014 P1~P3 done (**Slack→큐 전환 + route 게이트 동작**) | WORK-014 P4 (admin 큐 화면) |
