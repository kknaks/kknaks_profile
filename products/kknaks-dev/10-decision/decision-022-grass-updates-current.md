...
|---|---|---|---|
| OQ-1 | 「진행 중」 표의 열 구성을 company/studio 가 같게 갈지 | kknaks | 지금은 company 가 `Experience`, studio 가 `Work` 로 다르다 |
| OQ-2 | 활동이 없는 제품 행을 지우나 남기나 | kknaks | 지우면 「지난주에 뭘 했지」가 사라지고, 남기면 표가 계속 는다 |
