...
| WORK-016 | 비동기 실행 + 진행 표시 UI (제출/수확 분리·폴링·스피너) | BE+FE | in_progress (P1 done) | SPEC-008·009 | 015 | `work-016-async-execution-and-progress-ui.md` |
...
| SPEC-010 Apply Executor | WORK-015 | **구현 done** (P4) — 검증 6종·원자 커밋·전량 롤백·재시도. 실발행 e2e 만 남음 |
