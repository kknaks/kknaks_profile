...
| WP7 | AXKG-WORK-008 | Graph RAG 2단 retriever (qmd 사이드카) | AXKG-SPEC-006(retriever), 011(공유·`RETRIEVER_FALLBACK_USED`), DEC-003 개정 | WP2+WP4 | **todo** (PLAN-013 ①) |
| WP8 | AXKG-WORK-009 | 채팅→인박스 push (생각→방안→push) | AXKG-SPEC-006(push S-4), 003(chat 채널), 008(매트릭스), DEC-006 개정 | WP4+WP1+WP6 | **todo** (PLAN-013 ②) |
| WP9 | AXKG-WORK-010 | 인박스 md 업로드 intake | AXKG-SPEC-003(upload S-5), 012(경계) | WP1 | **todo** (PLAN-013 ③) |
...
| AXKG-WORK-008 | WP7: Graph RAG 2단 retriever (qmd 사이드카) | todo | AXKG-SPEC-006, AXKG-SPEC-011 |
| AXKG-WORK-009 | WP8: 채팅→인박스 push | todo | AXKG-SPEC-006, AXKG-SPEC-003, AXKG-SPEC-008 |
| AXKG-WORK-010 | WP9: 인박스 md 업로드 intake | todo | AXKG-SPEC-003, AXKG-SPEC-012 |

## Spec Coverage

| Spec | Covered by | Status |
|---|---|---|
| AXKG-SPEC-003 | AXKG-WORK-002 (WP1) · AXKG-WORK-009 (WP8, chat 채널) · AXKG-WORK-010 (WP9, upload 채널) | in-progress (원 URL intake done, chat·upload intake 잔여 — PLAN-013 ②③) |
...
| AXKG-SPEC-006 | AXKG-WORK-005 (WP4) · AXKG-WORK-008 (WP7, 2단 retriever) · AXKG-WORK-009 (WP8, push) | in-progress (원 chat done·라이브 e2e 2026-07-09, 2단 retriever·push 잔여 — PLAN-013 ①②) |
| AXKG-SPEC-007 | AXKG-WORK-006 (WP5) | done (AI Provider 설정 API) |
| AXKG-SPEC-008 | AXKG-WORK-001 (WP0) 골격 + AXKG-WORK-007 (WP6) role/authz + AXKG-WORK-009 (WP8) chat push 매트릭스 | in-progress (토큰 로그인 + role/authz done·admin 라이브 검증 2026-07-10, chat push 매트릭스 행 잔여 — PLAN-013 ②) |
| AXKG-SPEC-009 | AXKG-WORK-006 (WP5) | done (Prompts API — 버전/롤백/스키마 검증) |
| AXKG-SPEC-010 | AXKG-WORK-006 (WP5) | done (Templates API — 버전/롤백) |
| AXKG-SPEC-011 | AXKG-WORK-001(골격 done) + 002①(done) + 004②(done)·004③(in-progress)·005④(done) + 008(retriever 2단·폴백, todo) | in-progress (004③·008 잔여) |
| AXKG-SPEC-012 | AXKG-WORK-002 (WP1) · AXKG-WORK-010 (WP9, upload 경계) | in-progress (원 adapter done, upload 경계[adapter 대상 아님] 잔여 — PLAN-013 ③) |
