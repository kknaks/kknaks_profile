...
## 도메인 지식
- sc-ax — kknaks_profile 문서 리포의 제품 하나. **도메인 사실의 SSOT 는 `para/projects/summer-star/strong-hajin/00-baseline/`** —
...
- 린트: `python3 scripts/lint-pipeline.py --strict` (para/projects/summer-star/strong-hajin/ 범위 ERROR 0 이 기준)
