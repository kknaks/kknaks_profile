...
3. **문서 컨텍스트**: `AGENTS.md`, `rules/document-pipeline.md`, `para/projects/summer-star/strong-hajin/` 인덱스·baseline 을 필요한 범위에서 읽는다.
4. **기존 문서 탐색**: `para/projects/summer-star/strong-hajin/` 안에서 중복·충돌을 확인한다. 이미 있는 문서를 놔두고 새로 만들지 않는다.
