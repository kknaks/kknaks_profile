...
# 재개 노트 — data-backup (kknaks-dev)

**지금**: <한 줄 — 어디까지 왔고 무엇을 기다리나>
**다음**: <재개하면 바로 할 것 하나>

세팅: `scripts/new-work.sh kknaks-dev data-backup` · 설정 SSOT `config/projects/kknaks-dev.json`
코디handle: `<코디handle — stale 이라 미치환. 직접 확인해 채울 것>`
