# [reviewer] 회의록 시안 대조 1 — 회의록 생성 · 시작 전
...
| 문서 | 경로 |
|---|---|
| **담당 SPEC** | `20-spec/spec-006-meeting-setup.md` (443줄) |
...
산출물: `orchestration/work/docs-v1/meeting-review1-report.md`
...
orca orchestration send \\
  ...
  --subject "reviewer1 완료: <어긋남 n건>" \\
  --body "리포트 경로 / 어긋남 건수(신규·정정닫힘) / 가장 심각한 3건 요약 / 정해야 할 자리 / 판단 안 한 것"

orca terminal send --terminal term_6a4ac855-2a13-4484-b808-4c25182cbb2b \\
  --text "[worker_done] reviewer1 완료 — 어긋남 <n>건. 상세는 인박스." --enter
```
