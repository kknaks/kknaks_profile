...
| `reference.md` | `resources/source/{YYYY-MM-DD}-{slug}.md` | `reference` | `source` |
| `concept.md` | `resources/concept/{slug}.md` | `concept` | `concept` |
| `permanent.md` | `resources/synthesis/{slug}.md` | `permanent` | `synthesis` |

**이 파일들은 양식 원천이다.** 사람도 AI 도 여기를 보고 쓴다.
...
복사해 두면 양식 원천이 둘이 되고 한쪽만 고쳐지는 날 어긋난다.
