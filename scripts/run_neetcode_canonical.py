...
사용법:
    docker exec -w /repo/back kknaks-back uv run python ../scripts/run_neetcode_canonical.py

또는 로컬 (back/.env 박혀있고 redis worker 띄운 상태):
    cd back && uv run python ../scripts/run_neetcode_canonical.py
"""
