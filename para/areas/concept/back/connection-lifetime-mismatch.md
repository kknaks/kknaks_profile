...
- [[C-024-db-connection-pool-sizing-principles-and-production-pitfalls]] — HikariCP maxLifetime 기본값 30분과 PgBouncer server_idle_timeout 기본값 10분의 미스매치; 외부 풀러·프록시 도입 시 반드시 점검; 30초 이상 짧게 설정 권장; HikariCP 공식 문서 인용
