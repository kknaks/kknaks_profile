...
| SPEC-006 | 회의록 — 목록·생성·시작 전 | **구현 완료**(2026-09-07) | DEC-003 | 회의를 만들고 안건을 적고 시작한다 |
| SPEC-007 | 회의록 — 회의 중(STT·2트랙·AI 배치) | **구현 완료**(2026-09-07) | DEC-003 | 말하면 스크립트가 쌓이고 AI 탭이 찬다 |
| SPEC-008 | 회의록 — 종료·재전사·최종 회의록·편집·업무 연동 | **구현 완료**(2026-09-07) | DEC-003 | 재전사 뒤 AI 가 최종 회의록을 쓰고, 액션 줄의 「넣기」로 업무가 생긴다 |
