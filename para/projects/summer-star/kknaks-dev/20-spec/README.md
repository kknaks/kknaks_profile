...
|---|---|---|---|---|---|
| KDEV-SPEC-001 | 지식그래프 디렉토리 구조 (4층 + concept) | draft (**v0.0.15**) | DEC-001/002/008/010/015/**018** | WORK-013 | WORK-013 (todo) · **WORK-019 (미발주)** |
...
| KDEV-SPEC-008 | 게이트 체인 — 파이프라인 정의와 스테이지 계약 | draft (**v0.0.15**) | DEC-010/011/016/**021**/**023** | WORK-014·015·020·**021** | WORK-014·015 (todo) · WORK-021 (todo) |
...
| KDEV-SPEC-017 | 채용담당자 채팅 — 홈 히어로 · /chat · 익명 세션 · tool 경계 실행 | X
