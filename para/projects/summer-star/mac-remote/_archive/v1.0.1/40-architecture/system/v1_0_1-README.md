...
|---|---|---|---|
| iOS ↔ Mac | WebSocket / JSON 양방향 | 양방향 | [[v1_0_1-spec-005-websocket-protocol\|MRT-SPEC-005]] |
| iOS → Mac: listWindows | 창 목록 요청 | 단방향 | [[v1_0_1-spec-001-window-list\|MRT-SPEC-001]] |
| iOS → Mac: focus | 창 활성화 요청 | 요청/응답 | [[v1_0_1-spec-002-window-focus\|MRT-SPEC-002]] |
| iOS → Mac: key | 키 입력 요청 | 요청/응답 | [[v1_0_1-spec-003-key-input\|MRT-SPEC-003]] |
| Mac → iOS: windowList | 창 목록 push (1.5초) | push | [[v1_0_1-spec-001-window-list\|MRT-SPEC-001]] |
| Mac → iOS: appIcons | 아이콘 push (새 앱 시) | push | [[v1_0_1-spec-004-app-icon\|MRT-SPEC-004]] |
| Mac → iOS: permissions | 권한 상태 | 요청/응답 | [[v1_0_1-spec-006-permissions\|MRT-SPEC-006]] |
...
- 연결: iOS가 QR/수동 입력으로 받은 `ws://ip:8765`에 접속 → Mac이 full icon snapshot + windowList push 시작 ([[v1_0_1-spec-007-pairing\|MRT-SPEC-007]], 1.0.1에서 snapshot 보강).
