...
| 2 | 스크린샷 | **iPhone + iPad 세트 필수** (Universal 타겟 `1,2,7`). 기기 크기별, 자세한 규격은 [assets/README.md](assets/v1_0_1-README.md) |
...
> - 전체 플로우(QR 페어링 → 창 전환 → 매크로) **데모 영상**을 첨부하거나 노트에 링크한다. ([[v1_0_1-spec-007-pairing\|MRT-SPEC-007]])
...
- **제출 자산(스크린샷·아이콘) manifest**: [assets/README.md](assets/v1_0_1-README.md)
- 짝 런북: [runbook-001-mac-dmg-release.md](v1_0_1-runbook-001-mac-dmg-release.md)
