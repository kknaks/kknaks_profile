...
> 원본: `mac-remote/doc/spec/Spec-01-window-list.md`. 결정 근거는 [[v1_0_1-decision-002-cgwindowlist-window-source|MRT-DEC-002]].

## Context

- 관련 decision: [[v1_0_1-decision-002-cgwindowlist-window-source|MRT-DEC-002]] (CGWindowList를 창 소스로 채택)
- 비즈니스 요구: iOS 앱이 Mac의 열린 창을 보고 골라 전환하려면, 먼저 신뢰할 수 있는 창 목록 데이터가 필요하다. 모든 후속 기능(창 활성화·아이콘)의 기반.
- 관련 work: [[v1_0_1-work-001-cli-prototype|MRT-WORK-001]] (CLI 프로토타입), [[v1_0_1-work-005-websocket-server|MRT-WORK-005]] (계약 windowList 메시지)
- 범위
  - In: CGWindowListCopyWindowInfo 호출, 필터링, WindowInfo 모델 정의, windowList 메시지
  - Out: 창 활성화([[v1_0_1-spec-002-window-focus|MRT-SPEC-002]]), 화면 캡처/썸네일, 앱 아이콘([[v1_0_1-spec-004-app-icon|MRT-SPEC-004]])
...
- **CTA**: 카드 탭 → 해당 창 focus([[v1_0_1-spec-002-window-focus|MRT-SPEC-002]]), 햅틱 피드백 / Pull-to-refresh → listWindows 재요청
...
| Work | 범위 |
|---|---|
| [[v1_0_1-work-001-cli-prototype\|MRT-WORK-001]] | 창 목록 수집 + 필터 + WindowInfo 모델 (CLI) |
| [[v1_0_1-work-005-websocket-server\|MRT-WORK-005]] | 계약 windowList 메시지 (WS 서버) |
