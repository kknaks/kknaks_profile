...
| 2026-06-10 | release | MRT-REL-003 | **DeskDeck App Store 승인·출시** (1.0.1 build 5) — https://apps.apple.com/app/id6772868137. 랜딩 `APP_STORE_URL` 연결, release-003 작성 | [REL-003](60-release/release-003-deskdeck-appstore.md) |
| 2026-06-09 | review-resubmit | MRT-RB-002 | iOS 1.0.1 **build 5(DeskDeck)로 재제출** — ASC 앱 이름·부제 수정, build 5 선택, Resolution Center 회신, Submit for Review. 바이너리 표시명 DeskDeck 확인(ASC 빌드 메타). ⏳ 심사 대기 | [RB-002 §4](70-runbook/runbook-002-ios-testflight-appstore.md) |
