...
date: 2026.07.02
duration: '6:12'
speaker: VoltAgent (Nati, co-founder)
kind: study
youtubeId: 4v1ZFACsiRs
title:
  ko: VoltAgent 퀵스타트 데모 — 첫 번째 AI 에이전트와 워크플로우 구축
  en: VoltAgent Demo - Build Your First AI Agent and Workflow
summary:
  ko: VoltAgent CLI로 AI 에이전트를 부트스트랩하고 VoltOps 관측 플랫폼으로 에이전트·워크플로우 상태를 실시간 모니터링하는 공식 퀵스타트 데모
  en: 'Official quickstart demo: bootstrap an AI agent with the VoltAgent CLI and monitor agents/workflows live with VoltOps'
tags:
- ai-agent
- workflow
- human-in-the-loop
