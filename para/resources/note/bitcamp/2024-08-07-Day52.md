...
type: reference
id: 2024-08-07-Day52
title: Day52 MySQL기초(DML, DQL)
summary: insert·update·delete 로 데이터를 등록·변경·삭제하고 autocommit 을 끄고 commit/rollback 을 확인한 뒤, select 의 프로젝션·셀렉션과 논리·사칙·비교 연산자·between·like·is null, 그리고 MySQL 날짜 함수까지 다룬다
author: 이건학
date: 2024.08.07
tags:
- bitcamp
stack: [MySQL, SQL]
links: [2024-08-06-Day51, 2024-08-09-Day53]
---
...
- 사칙연산자
  ...
  ```
  ![image](https://github.com/user-attachments/assets/1df8f616-ef9e-4951-978f-deb15ff3c0ad)
...
- 비교연산자
  ...
  ```
  ![image](https://github.com/user-attachments/assets/e17d58fc-c683-4d59-8201-2e9df40a31a4)
 
  - between 값 and 값
  ```sql
  select 5 between 3 and 5;
  ```
  ![image](https://github.com/user-attachments/assets/1222aeb0-4168-42fe-b42d-70b36525c9bc)
