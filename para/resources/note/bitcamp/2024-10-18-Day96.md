...
type: reference
id: 2024-10-18-Day96
title: Day96 실습프로젝트(Spring boot)
summary: 실습 프로젝트를 스프링 부트로 옮기며 build.gradle의 스타터 의존성과 application.properties 한 파일로 DataSource·MyBatis·ViewResolver·multipart 설정을 대체한 회차
author: 이건학
date: 2024.10.18
tags:
  - bitcamp
