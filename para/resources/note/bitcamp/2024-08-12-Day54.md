...
summary: 외래키로 게시글과 첨부파일 테이블을 잇는 과정을 단계별로 적고, distinct·order by·as 별칭·count()·union 집합 연산을 이어 붙였다
author: 이건학
date: 2024.08.12
tags:
- bitcamp
stack: [MySQL, SQL]
links: [2024-08-09-Day53, 2024-08-13-Day55]
---
...
```
- DB구조
  ![image](https://github.com/user-attachments/assets/c4189b50-46d9-4d4a-b7c6-14002385a45f)
...
```
- DB구조
  ![image](https://github.com/user-attachments/assets/47f4d488-a992-4b6f-b7f5-173e2d5c346f)
...
![image](https://github.com/user-attachments/assets/bace4f9a-b46e-41ee-8894-ca5ae0db2504)
