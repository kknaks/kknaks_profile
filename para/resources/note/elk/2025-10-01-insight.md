---
type: reference
id: 2025-10-01-insight
title: Insight 탭 성능 개선 및 안정화
summary: 관심 그룹의 뉴스·공시 조회가 느리고 worker timeout 이 나던 문제를 원인 여섯 가지로 쪼갠 뒤, 조회를 MySQL 동기 접근에서 Elasticsearch 비동기 검색으로 옮기고 국가별로 나뉜 질의를 집계 하나로 합쳐 k6 로 개선을 측정한 실무 기록
author: 이건학
date: 2025.10.01
tags:
  - mysql
