...
summary: Terraform으로 VPC·보안그룹·EC2를 세우고 MySQL·Redis·Nginx Proxy Manager를 올린 뒤, 수동 배포를 거쳐 GitHub Actions(태그·이미지 푸시·SSM)와 socat 포트 전환 파이썬 스크립트로 무중단 배포까지 만든 회차
author: 이건학
date: 2025.01.13
tags:
  - 멋쟁이사자처럼
