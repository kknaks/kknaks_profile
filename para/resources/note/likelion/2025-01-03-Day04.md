...
summary: 행위를 URL이 아니라 HTTP 메서드로 표현하는 REST API를 기존 방식과 표로 대비하고, AWS CLI 설정부터 Terraform으로 인프라를 코드로 선언해 init·plan·apply·destroy로 다루는 과정을 정리한 회차
author: 이건학
date: 2025.01.03
tags:
  - 멋쟁이사자처럼
...
![image](https://github.com/user-attachments/assets/eb23ded0-7e72-4ab1-a7ce-0c020b5b3bee)
