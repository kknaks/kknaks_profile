    ...
    <div style={card}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
        ...
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <ChatExposureToggle kind="product" id={product.id} exposed={product.chatExposed} />
...
function ProductForm({
  ...
  return (
    <div style={{ ...card, marginBottom: 10, borderColor: "var(--line-2)" }}>
      ...
      {/* 레포는 제품의 속성 — 이 폼 안에서 등록한다. 행 조작은 저장 버튼과 무관하게 즉시 반영. */}
      {product && <RepoSection productId={product.id} />}
    </div>
  );
}
