        ...
        <>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            <Field label="제목 (ko)">
              <input
                value={card.title.ko}
                onChange={(e) => setCard({ ...card, title: { ...card.title, ko: e.target.value } })}
                style={input}
              />
            </Field>
            <Field label="제목 (en)">
              <input
                value={card.title.en}
                onChange={(e) => setCard({ ...card, title: { ...card.title, en: e.target.value } })}
                style={input}
              />
            </Field>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            <Field label="요약 (ko)">
              <input
                value={card.summary.ko}
                onChange={(e) =>
                  setCard({ ...card, summary: { ...card.summary, ko: e.target.value } })
                }
                style={input}
              />
            </Field>
            <Field label="요약 (en)">
              <input
                value={card.summary.en}
                onChange={(e) =>
                  setCard({ ...card, summary: { ...card.summary, en: e.target.value } })
                }
                style={input}
              />
            </Field>
